                                     ...
                                     <form method="POST" action="/admin/users/{{$user->id}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputfirstname" type="text"
                                                ...
                                                value="{{ old('fname', $user->fname) }}" required autocomplete="name" autofocus placeholder="First Name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputlastname" type="text"
                                                ...
                                                value="{{ old('lname', $user->lname) }}" required autocomplete="name" autofocus placeholder="Last Name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputemail" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror"
                                                name="email" value="{{ old('email', $user->email) }}" required autocomplete="email" placeholder="Email">
